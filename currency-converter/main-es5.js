...
var AddJsonInterceptor = /** @class */ (function () {
    function AddJsonInterceptor() {
    }
    AddJsonInterceptor.prototype.intercept = function (request, next) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('format', 'json');
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.submitHandler = function () {
        var amount = this.currencyForm.get("amount").value;
        var from = this.currencyForm.get("from").value;
        var to = this.currencyForm.get("to").value;
